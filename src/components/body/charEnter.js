...
export default function CharEnter({ setShowModal, isUpdate, currentCharacter, characterList, setCharacterList, setCurrentCharacter }) {
    ...
    const newCharacter = async () => {
        axios.post(`http://localhost:8080/character/`, {
            user: email,
    ...
    const deleteCharacter = async () => {
        axios.delete(`http://localhost:8080/character/${currentCharacter.charId}`)
        .then(res => {
    ...
    const updateCharacter = async () => {
        axios.patch(`http://localhost:8080/character/${currentCharacter.charId}`, 
        {
